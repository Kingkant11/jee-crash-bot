...
// ============================================
// LLM API Wrapper - Z.ai Coding API
// ============================================
...
`;
  ...
  try {
    ...
    if (jsonStart === -1 || jsonEnd === -1) {
      ...
      console.error('🔍 Full response (first 1000 chars):', jsonStr.substring(0, 1000));
    ...
    console.error('Raw LLM response that caused error:', response);  // ← Fixed: now safe
...
2. Identify 3 WEAKEST chapters (score < 60%)
...
Make tone URGENT and CONVINCING. Use emojis. Make them want to upgrade for ₹99.
...
*Powered by GLM-4-Flash AI via Z.ai Coding API*
  `;
...
• Take the final mock test on Day 7
